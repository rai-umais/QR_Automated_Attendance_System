...
class Session(db.Model):
    ...
    mode         = db.Column(db.String(10), default='normal', nullable=False)  # 'normal' or 'strict' or 'custom'
    custom_seconds = db.Column(db.Integer, nullable=True)
    master_xlsx_path = db.Column(db.String(255), nullable=True)
