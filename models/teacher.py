...
class Teacher(db.Model):
    ...
    courses = db.relationship('Course', backref = 'teacher', lazy = True)     #  backref='teacher' -> teacher is not the table name here, it is a python object that is created itself, here it is created on the 'Course' object that point backs to the teacher.
